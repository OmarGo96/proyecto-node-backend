...
export class Mailer {
    ...
    constructor() {
        ...
        this.hbsConfig = {
            viewEngine: {
                extName: '.hbs',
                partialsDir: path.join(__dirname, '../../files/templates/emails/'),
                layoutsDir: path.join(__dirname, '../../files/templates/emails/'),
                defaultLayout: ''
            },
            viewPath: path.join(__dirname, '../../files/templates/emails/'),
            extName: '.hbs'
        };
    }
